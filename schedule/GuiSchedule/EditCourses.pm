...
sub _create_right_click_menu {
    ...
    $teachers_list->bind(
                          '<Button-3>',
                          [
                             \&_show_teacher_menu, $teachers_list,
                             $tree,                Ev('X'),
                             Ev('Y')
                          ]
                        );
    ...
    $streams_list->bind(
                         '<Button-3>',
                         [
                            \&_show_stream_menu, $streams_list,
                            $tree,               Ev('X'),
                            Ev('Y')
                         ]
                       );
    ...
    $tree->bind(
                 '<Button-3>',
                 [
                    \&_show_tree_menu, $tree,
                    $teachers_list,    $labs_list,
                    $streams_list,     Ev('X'),
                    Ev('Y')
                 ]
               );
...
sub _create_drag_drop_objs {
    ...
    $teachers_list->DropSite( -droptypes   => [qw/Local/],
    ...
    $labs_list->DropSite( -droptypes   => [qw/Local/],
                          -dropcommand => [ \&_drop_on_trash, $tree ], );
    ...
    $streams_list->DropSite( -droptypes   => [qw/Local/],
                             -dropcommand => [ \&_drop_on_trash, $tree ], );
