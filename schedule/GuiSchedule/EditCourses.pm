...
sub _edit_course2 {
	...
	$secAdd = $frame2B->Button(
		...
		-command => sub {
			...
			my $answer = _edit_section2( $frame2B, $tree, $section,
	...
	$blockEdit = $frame2->Button(
		...
		-command => sub {
			if ( $curBlock ne "" ) {
				...
				my $answer    = _edit_block2( $frame2, $tree, $blockEdit,
